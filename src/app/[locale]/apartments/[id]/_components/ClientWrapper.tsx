    ...
    return (
        <>
            {!dataById ? (
                ...
                <main className="flex min-h-screen w-full flex-col gap-5 px-6 pb-10 pt-5 md:gap-8 lg:px-[280px]">
                                            ...
                                            <div className="relative flex justify-center p-0">
                                                ...
                                                <div className="relative z-10 w-full overflow-hidden md:w-auto">
                                                    <PhotoView src={item.original}>
                                                        <div className="relative aspect-square h-[300px] w-full cursor-zoom-in md:h-[500px] md:w-auto">
                                                            <Image
                                                                fill
                                                                src={item.original}
                                                                alt={`Image ${index}`}
                        ...
                        <div className="overflow-hidden" ref={thumbsRef}>
                            <div className="flex space-x-2">
                                {images.map((item, index) => (
                                    <div
                                        key={index}
                                        className={`flex-[0_0_auto] cursor-pointer overflow-x-auto ${
                                            index === selectedIndex
                                                ? 'ring-2 ring-mainGreen ring-offset-2'
                                                : ''
                                        }`}
                    ...
                    <div className="grid h-auto  w-full grid-cols-1 gap-4 rounded-lg border border-[#E3E3E3] p-4 shadow-lg md:grid-cols-3 md:gap-y-8  md:p-8">
                        ...
                        <div className="flex flex-row items-center gap-2 md:gap-2">
                            ...
                            {dataById?.getProperty?.housingHeatingTypes?.[0]?.translations?.[0]
                                ?.name || 'N/A'}
                        </div>
                        <div className="flex flex-row items-center gap-2 md:gap-2">

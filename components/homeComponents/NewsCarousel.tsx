          ...
          <CarouselContent className="pr-10 md:pr-16">
            {data.map((item, index) => (
              <CarouselItem key={index} className="w-full md:basis-1/2   ">
                <Card className="w-full rounded-xl bg-[#c0dbfc] ">
                  <CardContent className="w-full p-0   rounded-xl">
                    <div className="w-full pl-6 pt-6 pb-10 pr-24 flex flex-col relative md:pb-10 md:pt-8 md:pl-8 md:pr-[226px] ">

...
const faqData = [
  {
    question: "რა არის პლატფორმის გამოყენების ღირებულება?",
    answer:
    ...
    answer: (
      <>
        <p className="pl-0 pb-0">
          ...
          პლატფორმაზე პროპფილი დადასტურებამდე, მოხდება მისი გადამოწმება
  ...
  },
  {
    ...
    answer:
      "ჩვენი პლატფორმა უზრუნველყოფს, პირადი მონაცემების მასიმალურ დაცულობას. თქვენ თავად განსაზღვრავთ ვისთვის იყოს თქვენი საკონტაქტო მონაცემები ხელმისაწვდომი.",
  },
];

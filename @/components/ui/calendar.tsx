...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months:
          "flex flex-col  sm:flex-row sm:space-y-4 sm:space-x-4 sm:space-y-0",
        month: "space-y-0",
        ...
        day: cn(
          // buttonVariants({ variant: "calendarDay" }),
          "h-9 w-9 p-0  font-normal aria-selected:opacity-100 rounded-xl focus:text-white focus:bg-primaryBeta "
        ),
